...
// section owns its own full-height scroll container. AdsProviderStandalone gives
// every tools page ad-eligibility (Free/anonymous see ads; Pro does not) without
// depending on the editor-only AuthProvider.
